...
const toLastNames = people => {
  // Solution code here...
  let newArr = people.map(val => Object.values(val).join(' '));
  return newArr;
};
...
const validateWord = (word) => {
  // Solution code here...
  if (/^[a-zA-Z]{5,10}$/g.test(word)) return true;
  else return false;
};
...
const hasNumber = (string) => {
  // Solution code here...
  if (/[a-zA-Z]\d/g.test(string)) return true;
  else return false;
};
...
const validateEmail = (email) => {
  // Solution code here...
  if (/[\S\d]+@[\S\d]+\.[(com)|(net)|(org)]*/i.test(email)) return true;
  else return false;
};
...
const validatePhoneNumber = (phoneNumber) => {
  // Solution code here...
  if (/[a-z]/gi.test(phoneNumber)) return false;
  else {
    if (/[0-9{10}]/.test(phoneNumber)) return true;
    else return false;
  }
};
...
const findTagNames = elements => {
  // Solution code here...
  // let newArr = elements.map(val => val.match(/[\/+$]/g));
  // return newArr;
};
